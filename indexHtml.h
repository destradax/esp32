...
<html lang="en">
  <head>
    ...
    <style rel="stylesheet" crossorigin>body{text-align:center}fieldset{display:flex;flex-direction:column;gap:24px;max-width:400px}button{color:#fff;flex:1;padding:1em 0}#btnTurnOn{background-color:green}#btnTurnOff{background-color:red}</style>
  </head>
  <body>
    <div id="app">
      <h1>MVF</h1>
      <fieldset>
        ...
        <label>
          Pin:
          <input id="pinInput" type="number" inputmode="numeric" />
        </label>
